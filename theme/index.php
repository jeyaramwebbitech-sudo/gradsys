    ...
    <main>
        ...
        <section class="rs-banner-area rs-banner-nine rs-swiper">
            <div class="rs-banner-slider-wrapper">
                <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="2000" data-autoplay="true" data-dots-dynamic="false" data-hover-pause="true" data-effect="fade" data-delay="3000" data-item="1" data-margin="30" loop="true">
                                            ...
                                            <div class="rs-banner-wrapper">
                                                ...
                                                <div class="rs-banner-content">
                                                    ...
                                                    <div class="rs-banner-descrip">
                                                        <p>From concept to commissioning — multi-disciplinary engineering across oil & gas, power, and infrastructure
                                                        </p>
                                                    </div>
                                        ...
                                        <div class="col-xxl-8 col-xl-9 col-lg-10 col-md-10">
                                            <div class="rs-banner-wrapper">
                                                ...
                                                <div class="rs-banner-content">
                                                    ...
                                                    <div class="rs-banner-descrip">
                                                        <p>AI, data science, cyber security, and enterprise systems that power smarter operations
                                                        </p>
                                                    </div>
                                        ...
                                        <div class="col-xxl-8 col-xl-9 col-lg-10 col-md-10">
                                            <div class="rs-banner-wrapper">
                                                ...
                                                <div class="rs-banner-content">
                                                    ...
                                                    <div class="rs-banner-descrip">
                                                        <p>Design, build, and commission — complete electrical, mechanical, and automation project delivery
                                                        </p>
                                                    </div>
                                                    <div class="rs-banner-info-btn">
                                                        <div class="rs-banner-btn">
                        ...
                        <div class="rs-cta-wrapper">
                            ...
                            <div class="rs-cta-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                ...
                                <div class="rs-cta-call">
                                    <a href="tel:+197155157926">+1971 551 579 26</a>
                                </div>
                            </div>
        ...
        <!-- about area start -->
        <section class="rs-about-area rs-about-nine">
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-8 col-lg-8 order-1 order-lg-0">
                    ...
                    <div class="col-xl-4 col-lg-4 order-0 order-lg-1">
                        <div class="rs-about-thumb-wrapper">
                            <div class="rs-about-thumb rs-image scroll_reveal reveal_left reveal-active p-3">
                                <img decoding="async" src="assets/images/new-images/about.jpg" alt="image">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="rs-services-content-wrapper">
                            <div class="rs-section-title-wrapper">
                                ...
                                <h2 class="rs-section-title rs-split-text-enable split-in-fade">Engineering Services</h2>
                                <p class="descrip">We offer comprehensive engineering solutions across the entire project lifecycle, from conceptual studies to detailed design and analysis.

                                </p>
                                <h6 class="rs-services-text-link">
                                    <a href="#0">View All Services</a>
                                </h6>
                            </div>
                            <!-- If we need navigation buttons -->
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rs-services-item">
                                            <div class="rs-services-thumb">
                                                <a href="#0"><img
                                                        src="assets/images/new-images/ser-4.jpg"
                                                        alt="image"></a>
                                            </div>
                                            <div class="rs-services-content">
                ...
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-8 col-xl-9 col-lg-9">
                        <div class="rs-section-title-wrapper text-center"> 
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Digitization Services</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="swiper" data-clone-slides="false" data-loop="true" data-speed="2000"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/new-images/digi-1.jpg" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="#0">Digitization </a>
                                                </div>
                                                <h5 class="rs-portfolio-title"><a href="#0"> Data Visualization
                                                    </a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/new-images/digi-2.jpg" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="#0">Digitization </a>
                                                </div>
                                                <h5 class="rs-portfolio-title"><a href="#0"> Data Engineering
                                                    </a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/new-images/digi-3.jpg" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="#0">Digitization </a>
                                                </div>
                                                <h5 class="rs-portfolio-title"><a href="#0"> Data Science & ML
                                                    </a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/new-images/digi-4.jpg" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="#0">Digitization </a>
                                                </div>
                                                <h5 class="rs-portfolio-title"><a href="#0"> Artficial Intelligence
                                                    </a></h5>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/new-images/digi-5.jpg" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="#0">Digitization </a>
                                                </div>
                                                <h5 class="rs-portfolio-title"><a href="#0"> Web Development
                                                    </a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/new-images/digi-6.jpg" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="#0">Digitization </a>
                                                </div>
                                                <h5 class="rs-portfolio-title"><a href="#0"> Low Code / No Code
                                                    </a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            <div class="rs-portfolio-thumb">
                                                <img src="assets/images/new-images/digi-7.jpg" alt="image">
                                            </div>
                                            <div class="rs-portfolio-content">
                                                <div class="rs-portfolio-tag">
                                                    <a href="#0">Digitization </a>
                                                </div>
                                                <h5 class="rs-portfolio-title"><a href="#0"> Enterprice Data Management
                                                    </a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="rs-portfolio-item">
                                            ...
                                            <div class="rs-portfolio-content">
                                                ...
                                                <h5 class="rs-portfolio-title"><a href="#0"> Cyber Security (OT / ICS)
                                                    </a></h5>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!-- faq area start -->
        <section class="rs-faq-area rs-faq-one">
        ...
        <!-- brand area start -->
        <div class="rs-brand-area rs-brand-five rs-swiper has-pos-none">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
