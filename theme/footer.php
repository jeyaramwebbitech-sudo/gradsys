   ...
   <footer>
       <div class="rs-footer-area rs-footer-two has-theme-orange">
           <div class="rs-footer-bg-thumb has-bg-none" data-background="assets/images/bg/footer-bg-02.png"></div>
                   ...
                   <div class="row g-5">
                       <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6">
                           <div class="rs-footer-widget footer-2-col-1">
                               ...
                               <div class="rs-footer-widget-social mt-5">
                               ...
                               <div class="rs-footer-widget-content">
                                   <div class="rs-footer-widget-links">
                                       <ul>
                                           ...
                                           <li><a href="#">Digitization Services</a></li>
                                       </ul>
                                   </div>
                               </div>
                           </div>
                                   ...
                                   <div class="rs-footer-widget-contact-info">
                                       <div class="rs-footer-widget-number">
                                           ...
                                           <span>
                                               ...
                                               <div>
                                                   <a href="#0">130/59A, Malligai Street, Natraj Nagar, Kochadai, Madurai - 625016</a>
                                               </div>
                                           </span>
