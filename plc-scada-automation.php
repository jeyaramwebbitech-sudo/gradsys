                            ...
                            <div class="rs-breadcrumb-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><span>PLC / SCADA / Automation</span></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row g-5">
                    <div class="col-xl-12">
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <img decoding="async" src="assets/images/epic/PLC.jpg" alt="image">
                            </div>
                            <div class="col-lg-8">
                ...
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-8 col-xl-9 col-lg-9">
                        <div class="rs-section-title-wrapper text-center">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Supported Technologies</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5 process-counts">
