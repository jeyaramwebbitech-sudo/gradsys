                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/banner-1.webp">
                                </div>
                                <div class="container">
                        ...
                        <div class="swiper-slide">
                            <div class="rs-banner-item-wrapper">
                                <div class="rs-banner-bg-thumb" data-background="assets/images/banner-2.webp">
                                </div>
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xxl-8 col-xl-9 col-lg-10 col-md-10">
                ...
                <div class="row g-5">
                    <div class="col-xl-8 col-lg-8">
                        <div class="rs-section-title-wrapper section-title-space">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Trading Services</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5 process-counts">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-portfolio-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            <div class="rs-portfolio-thumb"
                                data-background="assets/images/new-images/ELV-Systems.jpg">
                            </div>
                            <div class="rs-portfolio-content">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="rs-testimonial-section-wrapper">
                            <div class="rs-section-title-wrapper">
                                ...
                                <h2 class="rs-section-title rs-split-text-enable split-in-fade mb-35">Trusted by Industry Leaders Worldwide</h2>
                                <p class="mb-0">
                                    We build long-term partnerships by delivering reliable engineering,
                                    automation, industrial solutions and exceptional customer service.
                                </p>
                            </div>
                            <!-- If we need navigation buttons -->
                                        ...
                                        <div class="rs-testimonial-item">
                                            <div class="rs-testimonial-quote">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="96" height="39" viewBox="0 0 96 39" fill="none">
                                                    <g opacity="0.06">
                                                        <path d="M0 29.2815H21.4286L7.14275 0.190567H28.5713L42.8572 29.2815V72.918H0V29.2815Z"
                                                            fill="#023B4A" />
                                                        <path d="M52.8574 72.918V29.2815H74.286L60.0002 0.190567H81.4288L95.7146 29.2815V72.918H52.8574Z"
                                                            fill="#023B4A" />
                                                    </g>
                                                </svg>
                                            </div>
                                            ...
                                            <div class="rs-testimonial-content">
                                                ...
                                                <div class="rs-testimonial-top">
                                                    <div class="rs-testimonial-avater-wrapper">
                                                        <div class="rs-testimonial-avater-thumb">
                                                            <img src="assets/images/new-images/testi.png" alt="">
                                                        </div>
                                                        <div class="rs-testimonial-avater-info">
                                                            <h6 class="rs-testimonial-avater-title">Project Director</h6>
                                                ...
                                                <div class="rs-testimonial-icon">
                                                    <img src="assets/images/brand/client-logo-01.png" alt="">
                                                </div>
                                            ...
                                            <div class="rs-testimonial-content">
                                                ...
                                                <div class="rs-testimonial-top">
                                                    <div class="rs-testimonial-avater-wrapper">
                                                        ...
                                                        <div class="rs-testimonial-avater-info">
                                                            <h6 class="rs-testimonial-avater-title">Engineering Manager</h6>
                                                            <span class="rs-testimonial-avater-designation">
                                                ...
                                                <div class="rs-testimonial-icon">
                                                    <img src="assets/images/brand/client-logo-02.png" alt="">
                                                </div>
                                            ...
                                            <div class="rs-testimonial-content">
                                                ...
                                                <div class="rs-testimonial-top">
                                                    <div class="rs-testimonial-avater-wrapper">
                                                        ...
                                                        <div class="rs-testimonial-avater-info">
                                                            <h6 class="rs-testimonial-avater-title">Operations Head</h6>
                                                            <span class="rs-testimonial-avater-designation">
                                                                Energy Sector
                                                            </span>
                                                        </div>
                                                ...
                                                <div class="rs-testimonial-icon">
                                                    <img src="assets/images/brand/client-logo-03.png" alt="">
                                                </div>
                                            ...
                                            <div class="rs-testimonial-content">
                                                ...
                                                <div class="rs-testimonial-top">
                                                    <div class="rs-testimonial-avater-wrapper">
                                                        ...
                                                        <div class="rs-testimonial-avater-info">
                                                            <h6 class="rs-testimonial-avater-title">Infrastructure Consultant</h6>
                                                            <span class="rs-testimonial-avater-designation">
                                                ...
                                                <div class="rs-testimonial-icon">
                                                    <img src="assets/images/brand/client-logo-04.png" alt="">
                                                </div>
